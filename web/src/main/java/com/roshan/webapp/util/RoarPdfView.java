package com.roshan.webapp.util;
...
/**
 * This class is a modification of {@link PdfView} to fix a compatibility issue with iText.
 * 
 * @author roshan
 *
 */
public class RoarPdfView implements BinaryExportView {
    ...
    static class PdfGenerationException extends BaseNestableJspTagException {
        ...
        public PdfGenerationException(Throwable cause) {
            super(RoarPdfView.class, Messages.getString("PdfView.errorexporting"), cause); //$NON-NLS-1$
        }
